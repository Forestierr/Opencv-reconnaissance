...
class DepthAI:
    def create_pipeline(self, model_name):
        ...
        spatialDetectionNetwork.setDepthUpperThreshold(5000) #5000
    ...
    def capture(self):
        for frame, detections in super().capture():
            ...
            for detection in detections:
                ...
                cv2.putText(frame, "z: {}".format(round(detection['depth_z'], 1)), (detection['x_min'], detection['y_min'] + 30), cv2.FONT_HERSHEY_TRIPLEX, 0.5, (255,255,255)) 
